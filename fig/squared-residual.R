...
me <- tapply(y, x, mean)
segments((1:2)-0.15, me, (1:2)+0.15, me, lwd=3, col="gray70")
abline(lm(y~x)$coef, col="blue", lwd=2)
points(1, 119.58, col = "red")
segments(x0 = 1, y0 = 104.4, y1 = 119, lwd=2, col="red")
segments(x0 = 1, y0 = 104.4, x1 = 1.5, y1 = 104.4, lwd=2, col="red")
segments(x0 = 1, y0 = 119, x1 = 1.5, y1 = 119, lwd=2, col="red")
segments(x0 = 1.5, y0 = 104.4, y1 = 119, lwd=2, col="red")
text(x = 1.2, y = 112, labels = "residual\nsquared")
text(x = 1.5, y = 90, labels = "QTL exists here")
png(filename = "squared-residual.png", width = 610, height = 600)
dev.off()