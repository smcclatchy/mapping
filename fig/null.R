...
segments(x0 = 1, y0 = mean(y), x1 = 1.64, y1 = mean(y), lwd=2, col="red")
segments(x0 = 1, y0 = 119, x1 = 1.64, y1 = 119, lwd=2, col="red")
segments(x0 = 1.64, y0 = mean(y), y1 = 119, lwd=2, col="red")
