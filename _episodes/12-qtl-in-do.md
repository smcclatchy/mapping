...
<img src="../fig/rmd-12-geno_plot-1.png" title="plot of chunk geno_plot" alt="plot of chunk geno_plot" style="display: block; margin: auto;" />
...
~~~
plot_coefCC(qtl, chr = 10, main = "prop.bm.MN.RET")
~~~
{: .r}
...
~~~
plot_snpasso(gwas, main = "prop.bm.MN.RET")
~~~
{: .r}
