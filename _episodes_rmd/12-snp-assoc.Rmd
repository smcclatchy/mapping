...
```{r plot_DOex_lod_curve, eval=FALSE}
par(mar=c(4.1, 4.1, 0.6, 0.6))
...
```{r grab_chr2_variants, eval=FALSE}
...
```{r DOex_find_peak_on_chr2, eval=FALSE}
...
```{r make_lookup_table, eval=FALSE}
...
```{r plot_snp_asso_wplot, eval=FALSE}
par(mar=c(4.1, 4.1, 0.6, 0.6))
...
```{r id_and_plot_genes, eval=FALSE}
