...
Kinship values between pairs of samples range between 0 (no relationship) and 1.0 (completely identical). Let's look at the kinship matrix for the first 100 animals.

```{r kinship_probs, fig.width=8, fig.height=8}
image(1:100, 1:100, K[[1]][1:100,100:1], xlab = "Samples",
      ylab = "Samples", yaxt = "n", main = "Kinship between samples",
      breaks = 0:100/100, col = hcl.colors(length(0:100) - 1, palette = "YlOrRd"))
```

The figure above shows kinship between all pairs of samples. Bright blue  indicates high kinship and dark purple indicates no kinship. Orange values indicate varying levels of kinship between 0 and 1. The white diagonal of the matrix indicates that each sample is identical to itself. The lighter yellow blocks off of the diagonal may indicate siblings or cousins.
